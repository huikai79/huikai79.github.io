...
assert.ok(!workflow.includes("workflow_run:"), "automatic translation writes must not be chained from sync/preflight workflow completion");
...
assert.ok(!workflow.includes("workflow_dispatch:"), "automatic queue must remain schedule-only");
